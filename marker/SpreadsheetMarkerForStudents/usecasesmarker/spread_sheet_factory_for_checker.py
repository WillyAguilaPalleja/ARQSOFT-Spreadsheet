from marker.SpreadsheetMarkerForStudents.usecasesmarker.spreadsheet_controller_for_checker import ISpreadsheetControllerForChecker
from marker.match_entities_for_marker_with_spreadsheet import MarkerController
