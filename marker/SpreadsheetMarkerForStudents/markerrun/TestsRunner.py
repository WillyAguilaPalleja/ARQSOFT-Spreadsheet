...
class TestRunner:
    ...
    def __init__(self):
        path1 = 'marker.SpreadsheetMarkerForStudents.markerrun.text_content_test.TextContentTest'
        path2 = 'marker.SpreadsheetMarkerForStudents.markerrun.number_content_test.NumberContentTest'
        path3 = 'marker.SpreadsheetMarkerForStudents.markerrun.formula_content_test.FormulaContentTest'
        path4 = 'marker.SpreadsheetMarkerForStudents.markerrun.dependent_cells_test.DependentCellsTest'
        path5 = 'marker.SpreadsheetMarkerForStudents.markerrun.circular_dependencies_test.CircularDependenciesTest'
