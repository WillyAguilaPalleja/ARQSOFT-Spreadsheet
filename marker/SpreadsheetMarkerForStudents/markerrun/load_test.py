...
class LoadTest(SuperClassForTests):
    ...
    def check_first_row(self,expected,cell_coords,valor):
        ...
        expected=["=1+2","=10/(2+3)","=A1*10-5","=(A5*4)/(A2+A2)","=100/(A5+(A5*A5/5))" \
            ...
            ,"=(A5*4)/(A2+A2)+SUM(A1;A2;3;4;5;A6:A12)","=(A5*4)/(A2+A2)+SUM(A1;A2;3;4;5;A6:A12;MIN(A13:A20))"]  # <- I think this is wrong, just before the MIN should be a semicolon, not a comma
